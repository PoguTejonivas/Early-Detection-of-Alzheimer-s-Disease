...
def predict():
    ...
    if predict==0:
        output='The Patient was either Converted Dementia or Non Dementia!'
   
    elif predict == 1:
        output = 'The Patient is diagnosis with Alzhemiers Disease, Demented!'

    elif predict == 2:
        output = 'The Patient is diagnosis with Non - Alzhemiers Disease, Non Demented!'
